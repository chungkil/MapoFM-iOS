...
struct Schedule {
    ...
    init() {
        programs = [
            ...
            Program(name: "뮤직흥(재)", dayOfWeek: .monday, startAt: "07:00", endAt: "07:30"),
            ...
            Program(name: "뮤직흥[시나쓰는 엘리스와 동네음악가]", dayOfWeek: .monday, startAt: "23:00", endAt: "24:00"),
            
            Program(name: "정파시간", dayOfWeek: .tuesday, startAt: "00:00", endAt: "07:00"),
            Program(name: "뮤직흥(재)", dayOfWeek: .tuesday, startAt: "07:00", endAt: "07:30"),
            ...
            Program(name: "블득킹(재)", dayOfWeek: .tuesday, startAt: "20:00", endAt: "21:00"),
            ...
            Program(name: "뮤직흥[야심한밤 이후민입니다]", dayOfWeek: .tuesday, startAt: "23:00", endAt: "24:00"),
            
            Program(name: "정파시간", dayOfWeek: .wednesday, startAt: "00:00", endAt: "07:00"),
            Program(name: "뮤직흥(재)", dayOfWeek: .wednesday, startAt: "07:00", endAt: "07:30"),
            ...
            Program(name: "뮤직흥[바람종의 바람그리기]", dayOfWeek: .wednesday, startAt: "23:00", endAt: "24:00"),
            
            Program(name: "정파시간", dayOfWeek: .thursday, startAt: "00:00", endAt: "07:00"),
            Program(name: "뮤직흥(재)", dayOfWeek: .thursday, startAt: "07:00", endAt: "07:30"),
            ...
            Program(name: "뮤직흥[체셔의 밤 라디오]", dayOfWeek: .thursday, startAt: "23:00", endAt: "24:00"),
            
            Program(name: "정파시간", dayOfWeek: .friday, startAt: "00:00", endAt: "07:00"),
            Program(name: "뮤직흥(재)", dayOfWeek: .friday, startAt: "07:00", endAt: "07:30"),
            ...
            Program(name: "곧목한쪽", dayOfWeek: .friday, startAt: "11:00", endAt: "12:00"),
            ...
            Program(name: "블득킹", dayOfWeek: .friday, startAt: "20:00", endAt: "21:00"),
            ...
            Program(name: "뮤직흥(재)", dayOfWeek: .saturday, startAt: "07:00", endAt: "07:30"),
            ...
            Program(name: "뮤직흥[한받의 한밤의 음악폭동]", dayOfWeek: .saturday, startAt: "23:00", endAt: "24:00"),
            
            Program(name: "정파시간", dayOfWeek: .sunday, startAt: "00:00", endAt: "07:00"),
            Program(name: "뮤직흥(재)", dayOfWeek: .sunday, startAt: "07:00", endAt: "07:30"),
            ...
            Program(name: "뮤직흥[라디오 속 오로빌]", dayOfWeek: .sunday, startAt: "23:00", endAt: "24:00"),
        ]
    }
